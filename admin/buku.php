...
include'sidebar.php';
 ...
 <div class="main">
   <b><i class="fa fa-Book"></i>Data Buku</b><a href="#" rel="tooltip" title="Tambah Data Buku"><button type="button" name="button" class="btn btn-secondary" style="margin-left:73%" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><i class="fa fa-fw fa-plus"></i></button>
    ...
    <table class="table table-hover">
      <thead align=center>
        <tr>
          ...
          <th scope="col" colspan="3" class="action">Aksi</th>
        </tr>
      </thead>
      <?php
